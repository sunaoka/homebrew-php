class PhpAT55 < Formula
  ...
  def install
    ...
    if OS.mac?
      ...
      ENV.append "EXTRA_LIBS", "#{Formula["openssl@1.0"].opt_prefix}/lib/libcrypto.dylib"
    end
    ...
    args = %W[
      ...
      --with-icu-dir=#{Formula["icu4c@74"].opt_prefix}
...
index 77c504d5..1d663356 100644
--- a/acinclude.m4
+++ b/acinclude.m4
@@ -444,7 +444,11 @@ dnl
...
@@ -455,8 +459,8 @@ AC_DEFUN([PHP_ADD_LIBPATH],[
       else
         _PHP_ADD_LIBPATH_GLOBAL([$ai_p])
       fi
-    ])
...
+  esac
 ...
 dnl
@@ -490,7 +494,11 @@ dnl add an include path.
...
+  *[)]
     ...
     PHP_RUN_ONCE(INCLUDEPATH, $ai_p, [
       if test "$2"; then
@@ -498,8 +506,8 @@ AC_DEFUN([PHP_ADD_INCLUDE],[
       else
...
@@ -2492,7 +2500,8 @@ AC_DEFUN([PHP_SETUP_ICONV], [
     fi
...
index bf9239d5..9360a51b 100644
...
index 933347b8..3183068f 100644
